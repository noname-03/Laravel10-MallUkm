@extends('layouts.app')
@section('title', 'Tambah Data Profil Perusahaan')
@section('content')
    @push('styles')
        <!-- Plugins css-->
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Tambah Data Profil Perusahaan</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Tambah Data Profil Perusahaan</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="latitude" name="latitude"
                                                    ...
                                                    placeholder="e.g : 6282311223344" value="{{ old('latitude') }}">
                                                @error('latitude')
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="longitude" name="longitude"
                                                    ...
                                                    placeholder="e.g : 6282311223344" value="{{ old('longitude') }}">
                                                @error('longitude')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number" id="phone" name="phone"
                                                    ...
                                                    placeholder="e.g : 6282311223344" value="{{ old('phone') }}">
                                                @error('phone')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="mb-3">
                                                <label for="terms" class="form-label">Syarat <span
                                                        class="text-danger">*</span></label>
                                                <textarea class="form-control @error('terms') is-invalid @enderror" id="terms" rows="3"
                                                    placeholder="e.g : bahwa ini adalah sesuatu yang baik dan benar" name="terms">{{ old('terms') }}</textarea>
                                                @error('terms')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control @error('conditions') is-invalid @enderror id=" conditions" rows="3"
                                                    placeholder="e.g : bahwa ini adalah sesuatu yang baik dan benar" name="conditions">{{ old('conditions') }}</textarea>
                                                @error('conditions')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
